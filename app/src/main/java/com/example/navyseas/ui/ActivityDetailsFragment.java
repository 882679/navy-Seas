...
public class ActivityDetailsFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_activity_details, container,
                false);
        ...
        if (isHome) {
            currentActivity = HomeFragment.db.getActivityByID(activityID);
        ...
        Button button = (Button) rootView.findViewById(R.id.btnDeleteReservation);
        button.setOnClickListener(v -> {
            HomeFragment.db.unsubscribe(new Reservation(isHome ? studentID : MainActivity.selectedStudent.getId(), isHome ? activityID : activity.getId()));
