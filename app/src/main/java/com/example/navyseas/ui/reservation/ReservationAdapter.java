...
public class ReservationAdapter extends RecyclerView.Adapter<ReservationAdapter.MyViewHolder> {
    ...
    public ReservationAdapter(Context context, FragmentManager getSupportFragmentManager, ArrayList<Activity> activityList, Student selectedStudent, ArrayList<Activity> studentActivities, DBHelper db) {
    ...
    public void restoreItem(Activity item, int position) {
        activityList.add(position, item);
