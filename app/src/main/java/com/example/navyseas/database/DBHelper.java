...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase database) {
		...
		database.execSQL("INSERT INTO " + ACTIVITY_TABLE +
				...
				" VALUES " +
				"('Scacchi', 'TEST DESCRIZIONE' ,'Lunedi', 8, 20), " +
				"('Lettura', 'TEST DESCRIZIONE' ,'Martedi', 7, 30), " +
				"('Disegno', 'TEST DESCRIZIONE' ,'Mercoledi', 5, 10), " +
				"('Pallavolo', 'TEST DESCRIZIONE' ,'Giovedi', 10, 50), " +
				"('Calcio', 'TEST DESCRIZIONE' ,'Venerdi', 15, 20), " +
				"('Aiuto compiti', 'TEST DESCRIZIONE' ,'Lunedi', 10, 60)"
		);

		database.execSQL(
				"INSERT INTO " + FAMILY_TABLE + " (" + FAMILY_COLUMN_NAME + ", " +
						FAMILY_COLUMN_EMAIL + ", " + FAMILY_COLUMN_PASSWORD + ")" +
						" VALUES ('Navy', 'test', 'test'), ('Seas', 'test1', 'test1')"
		);
